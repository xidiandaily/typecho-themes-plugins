...
<head>
    ...
    <!-- bootstrap -->
    <link rel="stylesheet" href="<?php $this->options->themeUrl('bootstrap/3.3.6/css/bootstrap.min.css'); ?>">
    <link rel="stylesheet" href="<?php $this->options->themeUrl('css/style.css'); ?>">
    <script src="http://libs.baidu.com/jquery/2.0.3/jquery.min.js"></script>
    <script src="<?php $this->options->themeUrl('bootstrap/3.3.6/js/bootstrap.min.js'); ?>"></script>
